            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    ?>
                        ...
                        <a class="nav-item nav-link" href="<?= base_url('booking') ?>">Booking Buku
                            <?= $this->ModelBooking->getDataWhere('temp', ['email_user' => $this->session->userdata('email')])->num_rows(); ?></a>
                    ...
                    <?php } else { ?>
                        ...
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#daftarModal" href="#">Daftar</a>
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#loginModal" href="#">Log in</a>
                    <?php } ?>
